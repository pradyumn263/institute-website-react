                            ...
                            <div className="rd-navbar-brand">
                                <Link className="d-inline-block" to="/">
                                    <div className="unit align-items-sm-center unit-xl flex-column flex-xxl-row unit-spacing-custom">
                                        <div className="unit-left">
                                            <img width={170} height={172} src={ process.env.PUBLIC_URL + "/images/logo-170x172.png"} alt={"nitw brand logo"} />
                                        </div>
                                        <div className="unit-body text-xxl-start">
                                            <div className="rd-navbar-brand-title">National Institute of Technology, Warangal</div>
